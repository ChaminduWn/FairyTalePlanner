...
const categoryImages = {
  ...
  "Photo Location": "/api/placeholder/1200/400",
  ...
  "Hotel": "/api/placeholder/1200/400"
};
...
const ServicesPage = () => {
  ...
  const categories = [
    "Photography", "Bridal Service", "Photo Location", 
    "Groom Dressing", "Car Rental", "Entertainment Services", 
    "Invitation & Gift Services", "Honeymoon", "Hotel"
  ];
